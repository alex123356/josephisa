...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Joseph Isa, I am independent web designer crafting distinctive, high-performance websites for brands that want to stand apart." },
      { name: "author", content: "Joseph Isa" },
      { property: "og:title", content: "Joseph Isa — Independent Web Designer" },
      { property: "og:description", content: "Joseph Isa, I am independent web designer crafting distinctive, high-performance websites for brands that want to stand apart." },
